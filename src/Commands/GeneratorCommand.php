...
abstract class GeneratorCommand extends Command
{
    ...
    protected function qualifyClass(string $name): string
    {
        ...
        return $namespace . '\\' . $name . $this->getSuffix();
    }
    ...
    protected function getOptions(): array
    {
        return [
            ...
            ['service', 's', InputOption::VALUE_OPTIONAL, 'The service name for class.', null],
            ['mapper', 'm', InputOption::VALUE_OPTIONAL, 'The Mapper name for class', null],
            ['request', 'r', InputOption::VALUE_OPTIONAL, 'The Request name for class', null],
            ['entity', 'e', InputOption::VALUE_OPTIONAL, 'The Model name for class', null]
        ];
    }
    ...
    protected function getConfig(): array
    {
        ...
        $key = 'spider.generator.' . Str::snake($class, '.');
